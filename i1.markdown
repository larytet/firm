...
The mother board carries a high end Xilinx FPGA with DDR, 500Mhz ARM, SmartCard reader (can store keys, for example), bootable SD card, bootable serial FLASH.
